    ...
    else if ( t == "if" )
    {
      ...
      else  // gexe
      {
        ...
        else  // 條件不成立 跳跳跳~
        {
          ...
          {
            num = 1 ;
            gexe_pos++ ; // 先拿掉一個 { 且 num 設為1

            while ( mCorrect_Token->at( gexe_pos ) != "}" || num > 0  )
            {

              gexe_pos++ ;

              if ( mCorrect_Token->at( gexe_pos ) == "{" )
                num++ ;
          ...
          {
            while ( mCorrect_Token->at( gexe_pos ) != ";"  )
            {
            ...
            else // 運算階段
            {
              ...
              else  // 跳過此文法不做
              {
                ...
                while ( num != 0 && num2 != 0 )
                {
                  ...
                  if ( num == 1 && mCorrect_Token->at( gexe_pos ) == "," )
                    num = 0 ;
